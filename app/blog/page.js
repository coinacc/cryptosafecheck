      ...
      <div className="max-w-4xl mx-auto px-4 xs:px-6 md:px-8 py-8 md:py-12">
        <div className="bg-white dark:bg-trust-800 rounded-lg shadow-sm border border-trust-200 dark:border-trust-700 p-6 xs:p-8 md:p-12">
          <div className="text-center mb-12">
            <h1 className="text-2xl xs:text-3xl font-semibold text-trust-900 dark:text-white mb-4">CryptoSafeCheck Blog</h1>
            <p className="text-trust-600 dark:text-trust-400 text-base xs:text-lg">Learn about crypto security, scam detection, and blockchain safety</p>
          </div>
          ...
          <div className="text-center py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <div className="p-6 bg-trust-50 dark:bg-trust-700 rounded-lg">
                <div className="w-10 h-10 bg-warning-100 dark:bg-warning-900 rounded-lg flex items-center justify-center mb-4 mx-auto">
              ...
              <div className="p-6 bg-trust-50 dark:bg-trust-700 rounded-lg">
                <div className="w-10 h-10 bg-success-100 dark:bg-success-900 rounded-lg flex items-center justify-center mb-4 mx-auto">
              ...
              <div className="p-6 bg-trust-50 dark:bg-trust-700 rounded-lg">
                <div className="w-10 h-10 bg-info-100 dark:bg-info-900 rounded-lg flex items-center justify-center mb-4 mx-auto">
                  <svg className="w-5 h-5 text-info-600 dark:text-info-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-12">
              <Link 
                href="/"
                className="inline-flex items-center px-6 py-3 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-all duration-200 font-medium shadow-sm hover:shadow-md active:scale-95"
              >
